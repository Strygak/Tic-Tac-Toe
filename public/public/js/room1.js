...
function checkSquares() {
    ...
    if (sq0 && sq1 && sq2) { 
        ...
        socket.emit("lineRoom1", { x1: 15, y1: 80, x2: 475, y2: 80, name: winnerName });
...
socket.on('goDrawRoom1', function(data) {
...
socket.on("sendLineRoom1", function(data) { 
